...
bugs = []
try:
    with open('C:/Users/daron/qa-automation-portfolio/week-02-oop/bugs_report.csv', 'r', encoding='utf-8-sig') as csvfile:
...
with open('C:/Users/daron/qa-automation-portfolio/week-02-oop/test_file.json', 'w') as json_file:
